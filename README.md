...
1. Start with the tail section:
   * Rear servos; The servos' cables should be routed through the cable route and be exposed to the forwards-most part of the tail
...
2. Main Body section:
   * ESCs; Route the wires through the holes that lead into the body, and seal the cable holes with sikiflex. Connect the 3 pin cable to an extender and run it below the wing box to the front of the body. Solder both ESCs' + and - input cables tp a single xt-60 connector, making sure to put the + and - the correct way around. 
